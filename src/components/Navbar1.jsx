        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/blogs" className="text-white hover:bg-[#0A8EA8] hover:text-white px-3 py-2 rounded-md text-sm font-medium">News</a>
      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="/blogs" className="text-white hover:bg-[#0A8EA8] hover:text-white block px-3 py-2 rounded-md text-base font-medium">News</a>
